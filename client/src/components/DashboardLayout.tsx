...
import { Home, Clock, LogOut, PanelLeft } from "lucide-react";
...
const menuItems = [
  { icon: Home, label: "Home", path: "/dashboard", requiresBrandId: true },
  { icon: Clock, label: "Queue", path: "/dashboard/queue", requiresBrandId: true },
];
